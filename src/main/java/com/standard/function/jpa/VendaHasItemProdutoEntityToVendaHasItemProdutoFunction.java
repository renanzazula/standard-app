...
public class VendaHasItemProdutoEntityToVendaHasItemProdutoFunction
	...
	public VendaHasItemProduto apply(VendaHasItemProdutoEntity input) {
		...
		if (input != null && input.getProdutoHasItensTipoMedida() != null) {
			output.setProdutoHasItensTipoMedida(JpaFunctions.produtoHasItensTipoMedidaEntityToProdutoHasItensTipoMedida.apply(input.getProdutoHasItensTipoMedida()));
